...
class Producto {
    ...
    public void venderProducto(int cantidad) {
        ...
        if (cantidad <= this.cantidadBodega) {
            ...
            totalVenta=cantidad*this.valorUnitario*(1+getIVA());
       ...
       if (cantidad>this.cantidadBodega ){     
           ...
           totalVenta=this.getCantidadBodega()*this.valorUnitario*(1+getIVA());
       }
        System.out.println("El valor total de la venta es "+totalVenta);
    }
...
// metodo incrementar el valor unitario en un porcentaje
    ...
    public String getNombreTipo(){
        ...
        //Mostrar un producto de la tienda
   ...
   public void mostrarProducto(){
            ...
            System.out.println("Cantidad en bodega "+this.cantidadBodega);
            System.out.println("Cantidad minima "+this.cantidadMinima);
            System.out.println("total Productos Vendidos "+this.totalProductosVendidos);
